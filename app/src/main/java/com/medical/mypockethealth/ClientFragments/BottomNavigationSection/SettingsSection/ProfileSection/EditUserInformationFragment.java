...
public class EditUserInformationFragment extends Fragment implements MorbidityCaller.CallbackFromMorbidityCaller,
    ...
    private boolean no_clicked=false,selectedImageStatus=false;
    ...
    public EditUserInformationFragment() {
    ...
    private void setData(View view)
    {
        ...
        if(clientInformation.getAllergieList()!=null)
        {
            ...
            for (AllergieList allergieList : clientInformation.getAllergieList()) {

                allergiesList.add(allergieList.getAllergyName());

            }

            addAllergiesRecycleViewAdaptor=new AddAllergiesRecycleViewAdaptor(allergiesList,
                    EditUserInformationFragment.this);
        ...
        if(clientInformation.getMorbiditiesList()!=null)
        {
            ...
            for (MorbiditiesList morbiditiesList : clientInformation.getMorbiditiesList()) {

                updatedMorbidityList.add(morbiditiesList.getMorbidityName());
            }

            addMorbidityRecycleViewAdaptor=new AddMorbidityRecycleViewAdaptor(updatedMorbidityList,
                    EditUserInformationFragment.this);
        ...
        if(clientInformation.getMedicationsList()!=null)
        {
            ...
            for (MedicationsList medicationsList : clientInformation.getMedicationsList()) {

                medicine.add(medicationsList.getMedicationName());
            }

            medicineListRecycleViewAdaptor=new AddMedicineListRecycleViewAdaptor(medicine,
                    EditUserInformationFragment.this);
        }
        ...
        {
            Picasso.with(getContext()).load(Uri.parse(clientInformation.getScript_image())).error(R.drawable.ic_plus__1_).into(upload_image);
            this.clientInformation.setScriptImage(clientInformation.getScript_image());
    ...
    private List<File> filterData(List<String> medicine)
    {
    ...
    public void uploadPatientData(ClientInformation clientInformation)
    {
        ...
        new Thread(new ClientInformationCaller(EditUserInformationFragment.this,clientInformation)).start();
    }
    ...
    private void getMorbidityList()
    {
        ...
        if (!(BaseActivity.network_status == NetworkStatus.TYPE_NOT_CONNECTED)) {
            ...
            new Thread(new MorbidityCaller(EditUserInformationFragment.this)).start();
    ...
    private void establishViews(View view)
    {
        ...
        addAllergiesRecycleViewAdaptor=new AddAllergiesRecycleViewAdaptor(allergiesList,   // for initial setup for allergies
                EditUserInformationFragment.this);
    ...
    private void disableAllergiesNumberFiled()
    {
        ...
        addAllergiesRecycleViewAdaptor.loadData(new ArrayList<>());
