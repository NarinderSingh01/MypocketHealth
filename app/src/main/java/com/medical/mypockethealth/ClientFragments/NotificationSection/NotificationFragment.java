package com.medical.mypockethealth.ClientFragments.NotificationSection;
...
public class NotificationFragment extends Fragment {
    ...
    private void getNotifications()
    {
        ...
        DatabaseReference databaseReference= FirebaseDatabase.getInstance()
                .getReference(URLBuilder.FirebaseDataNodes.Notification).child(ClientMainFrame.id).child(URLBuilder.FirebaseDataNodes.myNotification);
    ...
    private void updateNotificationStatus()
    {
        ...
        ActivationStateInformation activationStateInformation=new ActivationStateInformation("1",HomeFragment.activationStateInformation.getKey());

        databaseReference.child(ClientMainFrame.id).child(URLBuilder.FirebaseDataNodes.activationStatus)
                .child(HomeFragment.activationStateInformation.getKey()).setValue(activationStateInformation).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
