package com.medical.mypockethealth.ClientFragments.EHRSection.PrescriptionSection;
...
public class PrescriptionFragment extends Fragment implements PrescriptionRecycleViewAdaptor.callBackFromPrescriptionRecycleViewAdaptor,
        PrescriptionFileAccessCaller.CallbackFromPrescriptionFileAccessCaller{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        prescriptionRecycleViewAdaptor=new PrescriptionRecycleViewAdaptor(new ArrayList<>(), PrescriptionFragment.this);
    ...
    private void getPrescriptionNoteDetails()
    {
        if(!(BaseActivity.network_status == NetworkStatus.TYPE_NOT_CONNECTED))
        {
            ...
            new Thread(new PrescriptionFileAccessCaller(4, PrescriptionFragment.this, ClientMainFrame.id)).start();
    ...
    public void downloadFile(PrescriptionInformation prescriptionInformation) {
        ...
        if (permission != PackageManager.PERMISSION_GRANTED) {
            ...
            openBottomSheet(prescriptionInformation);
        }
    ...
    private void openBottomSheet(PrescriptionInformation prescriptionInformation)
    {
        ...
        forgotBottomSheet.findViewById(R.id.done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(folder_name.getText().toString().trim().length()!=0)
                {
                    ...
                    prescriptionInformation.setFolderName(folder_name.getText().toString());

                    startDownloading(prescriptionInformation);
    ...
    private void startDownloading(PrescriptionInformation prescriptionInformation)
    {

        openLoadingBox();

        String fileName=prescriptionInformation.getId()+".pdf";

        File dir = new File(Environment.getExternalStoragePublicDirectory(DIRECTORY_DOCUMENTS).getPath()
                +"/"+prescriptionInformation.getFolderName());
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                AndroidNetworking.download(baseUrl+"/"+prescriptionInformation.getId(),dir.toString(),fileName)
                        .setTag("downloadTest")
                    ...
                    public void onDownloadComplete() {
                        ...
                        loading_box.dismiss();
                        Toast.makeText(getContext(), "File saved to "+prescriptionInformation.getFolderName(), Toast.LENGTH_SHORT).show();
                    }
