...
public class SymptomCheckerElevenFragment extends Fragment {

    private static final String TAG = "SymptomCheckerElevenFra";

    private Dialog pop_up_box;

    public SymptomCheckerElevenFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_symptom_checker_eleven, container, false);
    }
        ...
        view.findViewById(R.id.backButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                requireActivity().getSupportFragmentManager().beginTransaction().replace(R.id.main_frame_layout,
                        new SymptomCheckerTenFragment()).addToBackStack(null).commit();
            }
        });
