...
public class FollowUpFileAccessCaller implements Runnable{

    private static final String TAG = "FollowUpInformationCall";

    private final int type;
    private final CallbackFromEhrFileAccessCaller callbackFromEhrFileAccessCaller;
    private final String userId;


    public FollowUpFileAccessCaller(int type, CallbackFromEhrFileAccessCaller callbackFromEhrFileAccessCaller, String userId) {
        this.type = type;
        this.callbackFromEhrFileAccessCaller = callbackFromEhrFileAccessCaller;
        this.userId = userId;
    }

    public interface CallbackFromEhrFileAccessCaller
    {

        void confirmationFollowUpFileAccessCaller(ResponseInformation responseInformation);
        void informationFollowUpFileAccessCaller(List<FollowUpInformation> followUpInformation,String baseUrl);
    }
    ...
    public void run() {
        ...
        try {
            ...
            if(callbackFromEhrFileAccessCaller!=null)
            {
                ...
                callbackFromEhrFileAccessCaller.confirmationFollowUpFileAccessCaller(responseInformation);
            }
        }
    ...
    private void jsonParser(String value) throws Exception
    {
        ...
        if(responseInformation.getSuccess().equals(String.valueOf(ResponseInformation.success_response_type)))
        {
            ...
            FollowUpInformationRoot followUpInformationRoot = gson.fromJson(value, FollowUpInformationRoot.class);

            if(callbackFromEhrFileAccessCaller!=null)
            {

                callbackFromEhrFileAccessCaller.informationFollowUpFileAccessCaller(followUpInformationRoot.getDetails(),followUpInformationRoot.getUrl());
            }
