...
public class BookedPatientDetailsCaller implements Runnable{

    private static final String TAG = "BookedPatientDetailsCal";

    private final CallbackFromBookedPatientDetailsCaller callbackFromBookedPatientDetailsCaller;


    public BookedPatientDetailsCaller(CallbackFromBookedPatientDetailsCaller callbackFromBookedPatientDetailsCaller) {
        this.callbackFromBookedPatientDetailsCaller = callbackFromBookedPatientDetailsCaller;
    }

    public interface CallbackFromBookedPatientDetailsCaller {
    ...
    public void run() {
        ...
        try {
            ...
            if(callbackFromBookedPatientDetailsCaller!=null)
            {
                ...
                callbackFromBookedPatientDetailsCaller.confirmation(responseInformation);
            }
        }
    ...
    private void jsonParser(String value) throws Exception {
        ...
        if (!responseInformation.getSuccess().equals(String.valueOf(ResponseInformation.fail_response_type))) {
            ...
            if(callbackFromBookedPatientDetailsCaller!=null)
            {
                ...
                callbackFromBookedPatientDetailsCaller.information(bookedClientInformationRoot.getDetails());
            }
